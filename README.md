...
Latest GitHub release: [C64Emulator 0.3.17](https://github.com/n1k0m0/C64Emulator/releases/tag/v0.3.17), including a self-contained Windows x64 setup package.
...
The latest Windows setup can be downloaded from the [GitHub Releases](https://github.com/n1k0m0/C64Emulator/releases) page. The current release is `0.3.17`.
