...
namespace C64Emulator.Core
{
    ...
    public sealed class Cia1
    {
        ...
        private byte _mouseJoystickPort1State = 0x1F;
        private byte _mouseJoystickPort2State = 0x1F;
        ...
        public void Reset()
        {
            ...
            _mouseJoystickPort1State = 0x1F;
            _mouseJoystickPort2State = 0x1F;
        ...
        public string GetDebugInfo()
        {
            return string.Format(
                ...
                _todSeconds,
                _todTenths,
                _joystickPort1State & _gamepadJoystickPort1State & _networkJoystickPort1State & _mouseJoystickPort1State,
                _joystickPort2State & _gamepadJoystickPort2State & _networkJoystickPort2State & _mouseJoystickPort2State);
        }
        ...
        /// <summary>
        /// Sets the joystick-line contribution generated by a Commodore 1351 mouse.
        /// </summary>
        /// <param name="mousePort">Control port containing the emulated mouse.</param>
        /// <param name="activeLowJoystickState">Active-low button state generated by the mouse.</param>
        public void SetMouse1351JoystickState(Mouse1351Port mousePort, byte activeLowJoystickState)
        {
            activeLowJoystickState = (byte)(activeLowJoystickState | 0xE0);
            _mouseJoystickPort1State = 0x1F;
            _mouseJoystickPort2State = 0x1F;

            if (mousePort == Mouse1351Port.Port1)
            {
                _mouseJoystickPort1State = activeLowJoystickState;
            }
            else if (mousePort == Mouse1351Port.Port2)
            {
                _mouseJoystickPort2State = activeLowJoystickState;
            }
        }
        ...
        private byte ReadPortA()
        {
            ...
            result = (byte)(result & ((_joystickPort2State & _gamepadJoystickPort2State & _networkJoystickPort2State & _mouseJoystickPort2State) | 0xE0));
            return result;
        }
        ...
        private byte ReadPortB()
        {
            ...
            result = (byte)(result & ((_joystickPort1State & _gamepadJoystickPort1State & _networkJoystickPort1State & _mouseJoystickPort1State) | 0xE0));
